...
function soj_register_resources_post_type()
{
    $labels = array(
        'name'                  => _x('Resources', 'Post Type General Name', 'soj-core'),
        'singular_name'         => _x('Resource', 'Post Type Singular Name', 'soj-core'),
        'menu_name'             => __('Resources', 'soj-core'),
        'name_admin_bar'        => __('Resource', 'soj-core'),
        'archives'              => __('Resource Archives', 'soj-core'),
        'attributes'            => __('Resource Attributes', 'soj-core'),
        'parent_item_colon'     => __('Parent Resource:', 'soj-core'),
        'all_items'             => __('All Resources', 'soj-core'),
        'add_new_item'          => __('Add New Resource', 'soj-core'),
        'add_new'               => __('Add New', 'soj-core'),
        'new_item'              => __('New Resource', 'soj-core'),
        'edit_item'             => __('Edit Resource', 'soj-core'),
        'update_item'           => __('Update Resource', 'soj-core'),
        'view_item'             => __('View Resource', 'soj-core'),
        'view_items'            => __('View Resources', 'soj-core'),
        'search_items'          => __('Search Resources', 'soj-core'),
        ...
        'insert_into_item'      => __('Insert into resource', 'soj-core'),
        'uploaded_to_this_item' => __('Uploaded to this resource', 'soj-core'),
        'items_list'            => __('Resources list', 'soj-core'),
        'items_list_navigation' => __('Resources list navigation', 'soj-core'),
        'filter_items_list'     => __('Filter resources list', 'soj-core'),
    );

    $args = array(
        'label'               => __('Resources', 'soj-core'),
        'description'         => __('Resources', 'soj-core'),
        'labels'              => $labels,
...
add_action('init', 'soj_register_resources_post_type');

/**
 * Show Resource ACF fields directly after the title.
 */
function soj_resource_acf_after_title($field_group)
{
    ...
    if (! $screen || $screen->base !== 'post' || $screen->post_type !== 'resource') {
        return $field_group;
    }
...
add_filter('acf/get_field_group', 'soj_resource_acf_after_title');

/**
 * Disable block editor for Resource post type.
 */
function soj_disable_resource_block_editor($use_block_editor, $post_type)
{
