...
│   └── style.css    # Compiled (npm run build:blocks; watched via npm run dev)
├── js/
│   └── script.js    # Block JavaScript (bundled in main.js)
├── group_6a1ae668.json # ACF field group (edit in WP admin)
└── preview.png      # Inserter preview image
```

## Usage

1. Edit fields in WP Admin › ACF › Field Groups › Block : Intro
