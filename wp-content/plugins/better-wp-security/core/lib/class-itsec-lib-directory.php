<?php
/**
 * Kadence Security directory library.
 *
...
if ( ! class_exists( 'ITSEC_Lib_Directory' ) ) {
	/**
	 * Kadence Security Directory Library class.
	 *
	...
	class ITSEC_Lib_Directory {
		...
		public static function is_writable( $dir ) {
			...
			$result = ITSEC_Lib_File::write( "$dir/$test_file", __( 'This is a test file generated by Kadence Security. It can be removed.', 'better-wp-security' ) );
