...
final class ITSEC_Two_Factor_Privacy {
	...
	public function get_privacy_policy_for_sharing( $policy ) {
		...
		/* Translators: 1: Link to WordPress's privacy policy, 2: Link to Kadence's privacy policy, 3: Link to Amazon AWS's privacy policy */
		$policy .= "<p>$suggested_text " . sprintf( wp_kses( __( 'A QR code image is generated for users that set up two-factor authentication for this site. This image is generated using a Kadence-hosted API. In the process of generating this image, your username is sent to the API. This data is not logged. For privacy policy details, please see the <a href="%1$s">Kadence Privacy Policy</a>.', 'better-wp-security' ), array( 'a' => array( 'href' => array() ) ) ), 'https://solidwp.com/privacy-policy' ) . "</p>\n";
