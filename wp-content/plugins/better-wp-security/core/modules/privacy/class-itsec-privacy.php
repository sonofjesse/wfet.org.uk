...
final class ITSEC_Privacy {
	...
	public function admin_init() {
		if ( function_exists( 'wp_add_privacy_policy_content' ) ) {
			wp_add_privacy_policy_content( 'Kadence Security', $this->get_privacy_policy_content() );
		}
	}
	...
	public function register_exporter( $exporters ) {
		$exporters['ithemes-security'] = array(
			'exporter_friendly_name' => __( 'Kadence Security Plugin', 'better-wp-security' ),
	...
	public function register_eraser( $erasers ) {
		$erasers['ithemes-security'] = array(
			'eraser_friendly_name' => __( 'Kadence Security Plugin', 'better-wp-security' ),
