...
class Compatibility
{
  ...
  public static function add_notice()
  {
    ...
    echo '<div class="notice notice-error is-dismissible"><p><b>FlyingPress</b> detected plugin(s) that are unnecessary and may impact performance. Please deactivate them:' .
      '<br/><ul>';
